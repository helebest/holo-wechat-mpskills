...
class StatsManager:
    ...
    def _validate_date_range(self, begin_date: str, end_date: str, max_days: int) -> None:
        """验证日期范围"""
    ...
    def get_user_summary(self, begin_date: str, end_date: str) -> List[Dict[str, Any]]:
        """
        获取用户增减数据
        ...
        result = self.client.post(
            "/datacube/getusersummary", json_data={"begin_date": begin_date, "end_date": end_date}
        )
        return result.get("list", [])

    def get_user_cumulate(self, begin_date: str, end_date: str) -> List[Dict[str, Any]]:
        """
        获取累计用户数据
        ...
        result = self.client.post(
            "/datacube/getusercumulate", json_data={"begin_date": begin_date, "end_date": end_date}
        )
        return result.get("list", [])
    ...
    def get_article_summary(self, date: str) -> List[Dict[str, Any]]:
        ...
        result = self.client.post(
            "/datacube/getarticlesummary", json_data={"begin_date": date, "end_date": date}
        )
        return result.get("list", [])
    ...
    def get_article_total(self, date: str) -> List[Dict[str, Any]]:
        ...
        result = self.client.post(
            "/datacube/getarticletotal", json_data={"begin_date": date, "end_date": date}
        )
        return result.get("list", [])

    def get_user_read(self, begin_date: str, end_date: str) -> List[Dict[str, Any]]:
        """
        获取图文阅读概况数据
        ...
        result = self.client.post(
            "/datacube/getuserread", json_data={"begin_date": begin_date, "end_date": end_date}
        )
        return result.get("list", [])
    ...
    def get_user_read_hour(self, date: str) -> List[Dict[str, Any]]:
        ...
        result = self.client.post(
            "/datacube/getuserreadhour", json_data={"begin_date": date, "end_date": date}
        )
        return result.get("list", [])

    def get_user_share(self, begin_date: str, end_date: str) -> List[Dict[str, Any]]:
        """
        获取图文转发概况数据
        ...
        result = self.client.post(
            "/datacube/getusershare", json_data={"begin_date": begin_date, "end_date": end_date}
        )
        return result.get("list", [])
    ...
    def get_user_share_hour(self, date: str) -> List[Dict[str, Any]]:
        ...
        result = self.client.post(
            "/datacube/getusersharehour", json_data={"begin_date": date, "end_date": date}
        )
        return result.get("list", [])

    # ==================== 消息数据 ====================

    def get_upstream_msg(self, begin_date: str, end_date: str) -> List[Dict[str, Any]]:
        """
        获取消息发送概况数据
        ...
        result = self.client.post(
            "/datacube/getupstreammsg", json_data={"begin_date": begin_date, "end_date": end_date}
        )
        return result.get("list", [])
    ...
    def get_upstream_msg_hour(self, date: str) -> List[Dict[str, Any]]:
        ...
        result = self.client.post(
            "/datacube/getupstreammsghour", json_data={"begin_date": date, "end_date": date}
        )
        return result.get("list", [])

    def get_upstream_msg_week(self, begin_date: str, end_date: str) -> List[Dict[str, Any]]:
        """
        获取消息发送周数据
    ...
    def get_upstream_msg_month(self, begin_date: str, end_date: str) -> List[Dict[str, Any]]:
        """
        获取消息发送月数据
    ...
    def get_upstream_msg_dist(self, begin_date: str, end_date: str) -> List[Dict[str, Any]]:
        """
        获取消息发送分布数据
    ...
    def get_interface_summary(self, begin_date: str, end_date: str) -> List[Dict[str, Any]]:
        """
        获取被动回复概要数据
    ...
    def get_interface_summary_hour(self, date: str) -> List[Dict[str, Any]]:
        ...
        result = self.client.post(
            "/datacube/getinterfacesummaryhour", json_data={"begin_date": date, "end_date": date}
        )
        return result.get("list", [])
...
# 便捷函数
def create_stats_manager(client: Optional[WeChatClient] = None) -> StatsManager:
    """创建数据统计管理器实例"""
    if client is None:
        client = WeChatClient()
